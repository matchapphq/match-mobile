...
const FEATURED_CARD_WIDTH = Math.min(SCREEN_WIDTH * 0.74, 300);
const RECENT_CARD_WIDTH = Math.min(SCREEN_WIDTH * 0.8, 300);
            ...
            <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 120 + insets.bottom }}>
                ...
                <View style={styles.section}>
                    <View style={styles.sectionHeaderRow}>
                        <Text style={[styles.sectionTitle, styles.bottomSectionTitle]}>Récemment vus</Text>
                ...
                <View style={[styles.section, { paddingHorizontal: 24 }]}>
                    <Text style={[styles.sectionTitle, styles.bottomSectionTitle, { marginBottom: 4 }]}>Matchs à venir</Text>
...
const styles = StyleSheet.create({
    ...
    scroll: { flex: 1 },
    heroSection: { position: "relative", width: "100%", marginTop: 10 },
    heroSlide: { width: SCREEN_WIDTH, height: 206 },
    heroCard: { flex: 1 },
    heroImage: { ...StyleSheet.absoluteFillObject, opacity: 0.45 },
    heroShade: { ...StyleSheet.absoluteFillObject },
    heroContent: { flex: 1, justifyContent: "flex-end", paddingHorizontal: 22, paddingBottom: 34 },
    heroMetaRow: { flexDirection: "row", alignItems: "center", gap: 6, marginBottom: 5 },
    heroBadge: { backgroundColor: "rgba(255,255,255,0.2)", color: "#fff", fontSize: 10, fontWeight: "800", textTransform: "uppercase", borderRadius: 4, paddingHorizontal: 9, paddingVertical: 3, overflow: "hidden" },
    heroDate: { color: "rgba(255,255,255,0.82)", fontSize: 11, fontWeight: "600" },
    heroTitle: { color: "#fff", fontSize: 39, fontWeight: "900", fontStyle: "italic", letterSpacing: -0.5 },
    heroBottomRow: { marginTop: 3, flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
    heroSubtitle: { color: "#e5e7eb", fontSize: 13, fontWeight: "500" },
    heroAction: { backgroundColor: "#f47b25", borderRadius: 9, paddingHorizontal: 12, paddingVertical: 7, flexDirection: "row", alignItems: "center", gap: 4 },
    heroActionText: { color: "#fff", fontSize: 11, fontWeight: "800" },
    heroDots: { position: "absolute", bottom: 12, left: 0, right: 0, flexDirection: "row", justifyContent: "center", gap: 7 },
    dotActive: { width: 7, height: 7, borderRadius: 99, backgroundColor: "#fff" },
    dot: { width: 7, height: 7, borderRadius: 99, backgroundColor: "rgba(255,255,255,0.4)" },
    section: { marginTop: 18, gap: 8 },
    bottomSectionTitle: { fontSize: 23 },
    sectionHeaderRow: { paddingHorizontal: 24, flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
    sectionTitle: { color: "#fff", fontSize: 21, fontWeight: "800", paddingHorizontal: 24 },
    rowPad: { paddingHorizontal: 24, gap: 14 },
    teamItem: { minWidth: 64, alignItems: "center", gap: 5 },
    teamRing: { width: 64, height: 64, borderRadius: 99, padding: 2, position: "relative" },
    ...
    teamPlain: { width: 64, height: 64, borderRadius: 99, borderWidth: 2, borderColor: "rgba(255,255,255,0.1)", backgroundColor: "#1c1c21", alignItems: "center", justifyContent: "center", padding: 5 },
    ...
    teamAdd: { width: 64, height: 64, borderRadius: 99, borderWidth: 2, borderStyle: "dashed", borderColor: "rgba(255,255,255,0.2)", backgroundColor: "rgba(255,255,255,0.05)", alignItems: "center", justifyContent: "center" },
    teamLabel: { width: 64, textAlign: "center", color: "#fff", fontSize: 10, fontWeight: "600" },
    competitionRow: { paddingHorizontal: 24, gap: 10 },
    competitionItem: { minWidth: 54, alignItems: "center", gap: 5 },
    competitionCircle: { width: 54, height: 54, borderRadius: 99, backgroundColor: "#1c1c21", borderWidth: 1, borderColor: "rgba(255,255,255,0.05)", alignItems: "center", justifyContent: "center" },
    competitionLabel: { width: 64, textAlign: "center", color: "#a1a1aa", fontSize: 9, fontWeight: "700", textTransform: "uppercase" },
    featuredRow: { paddingHorizontal: 24, gap: 14 },
    featuredCard: { height: 188, borderRadius: 14, overflow: "hidden", borderWidth: 1, borderColor: "rgba(255,255,255,0.05)", backgroundColor: "#1c1c21" },
    featuredImage: { width: "100%", height: "100%", opacity: 0.92 },
    featuredShade: { ...StyleSheet.absoluteFillObject },
    featuredTag: { position: "absolute", top: 9, left: 9, backgroundColor: "rgba(244,123,37,0.9)", borderRadius: 4, paddingHorizontal: 7, paddingVertical: 3 },
    featuredTagText: { color: "#fff", fontSize: 9, fontWeight: "800", textTransform: "uppercase" },
    featuredBottom: { position: "absolute", left: 12, right: 12, bottom: 12 },
    featuredTopRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
    featuredInfo: { color: "#f47b25", fontSize: 10, fontWeight: "700" },
    reserveBtn: { backgroundColor: "#fff", borderRadius: 8, paddingHorizontal: 11, paddingVertical: 5 },
    reserveText: { color: "#000", fontSize: 10, fontWeight: "800" },
    featuredTitle: { color: "#fff", marginTop: 3, fontSize: 18, fontWeight: "800" },
    featuredDetails: { marginTop: 1, color: "#f3f4f6", fontSize: 11, fontWeight: "500" },
    clearText: { color: "#a1a1aa", fontSize: 11, fontWeight: "600" },
    recentRow: { paddingHorizontal: 24, gap: 14 },
    recentCard: { minHeight: 94, borderRadius: 14, padding: 11, flexDirection: "row", gap: 13, backgroundColor: "#232329", borderWidth: 1, borderColor: "rgba(255,255,255,0.05)", position: "relative" },
    recentImage: { width: 72, height: 72, borderRadius: 9 },
    recentContent: { flex: 1, justifyContent: "center", gap: 2 },
    recentTitle: { color: "#fff", fontSize: 14, fontWeight: "800", paddingRight: 30 },
    recentSub: { color: "#a1a1aa", fontSize: 11, fontWeight: "500" },
    recentSubSmall: { color: "#a1a1aa", fontSize: 10, fontWeight: "500", marginTop: 2 },
    score: { position: "absolute", right: 10, top: 10, backgroundColor: "#166534", borderRadius: 4, paddingHorizontal: 5, paddingVertical: 2 },
    scoreText: { color: "#d1fae5", fontSize: 9, fontWeight: "800" },
    upcomingList: { gap: 12 },
    upcomingCard: { backgroundColor: "#1c1c21", borderRadius: 14, borderWidth: 1, borderColor: "rgba(255,255,255,0.05)", minHeight: 88, paddingHorizontal: 13, paddingVertical: 12, flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
    upcomingSide: { flex: 1, flexDirection: "row", alignItems: "center", gap: 11 },
    right: { justifyContent: "flex-end" },
    code: { width: 34, height: 34, borderRadius: 99, backgroundColor: "#2b2b32", borderWidth: 1, borderColor: "rgba(255,255,255,0.1)", alignItems: "center", justifyContent: "center" },
    codeText: { color: "#cbd5e1", fontSize: 10, fontWeight: "800" },
    teamName: { color: "#fff", fontSize: 14, fontWeight: "700" },
    teamLeague: { color: "#a1a1aa", fontSize: 10, fontWeight: "500" },
    centerBlock: { alignItems: "center", paddingHorizontal: 6 },
    timePill: { borderRadius: 6, paddingHorizontal: 8, paddingVertical: 4, borderWidth: 1 },
    ...
    whenText: { marginTop: 3, color: "#a1a1aa", fontSize: 9, fontWeight: "500" },
});

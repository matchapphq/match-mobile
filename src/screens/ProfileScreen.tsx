...
const ProfileScreen = () => {
  ...
  const menuItems = [
    ...
    { id: 'reservations', label: 'Mes réservations', icon: 'people-outline', color: theme.colors.primary },
    { id: 'notifications', label: 'Notifications', icon: 'notifications-outline', color: theme.colors.primary },
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.profileSection}>
        <View style={styles.avatarContainer}>
          <View style={styles.avatarInner}>
            <Image 
              source={{ uri: 'https://api.dicebear.com/7.x/avataaars/png?seed=match' }} 
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={styles.footerButton}>
          ...
          <Text style={styles.footerText}>Proposer un lieu{'\n'}sur Match</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
